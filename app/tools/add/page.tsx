        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" value={name} onChange={handleNameChange} placeholder="ex: Lighthouse" required />
            </div>

            <div className="space-y-2">
              <Label htmlFor="slug">Slug (obligatoire)</Label>
              <Input id="slug" value={slug} onChange={handleSlugChange} placeholder="ex: lighthouse" required />
